...
def getImage():
    LINK = "http://192.168.43.89:8080/shot.jpg"
    r = requests.get(LINK)
...
def sendMail():
    ...
    gmail_user = "blindpersonhelperservice"
    gmail_pwd = "crucified830"
    TO = 'jhajha135@gmail.com'
    SUBJECT = "EMERGENCY! HELP!"
    TEXT="hi"
    #TEXT = "Hey! I have run into some problems. Please pick me up. I'm at Coordinates are"
...
def climate():
    ...
    #speak("Enter the name of the city you want the weather forecast for: ")
    city = addre.city()
    ...
    with tf.Session(graph=detection_graph) as sess:
        ...
        while (ret):
            ...
            if todo==4:
                ...
                print("You are at " + addre.address())
                speak("You are at " + addre.address())
                break
